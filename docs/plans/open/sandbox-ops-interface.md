...
Status: ⬜ not started. **Ship in the same PR as [`defineTool` factory](./define-tool-factory.md)** — both refactor `src/lib/agents/tools.ts` end-to-end; doing them separately means rewriting tools.ts twice.
